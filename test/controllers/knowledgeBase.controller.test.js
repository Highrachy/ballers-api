    ...
    it('returns successful payload', (done) => {
      request()
        ...
        .end((err, res) => {
          ...
          expect(res.body.post.author.firstName).to.eql(admin.firstName);
          expect(res.body.post.author.lastName).to.eql(admin.lastName);
          expect(res.body.post.author.about).to.eql(admin.about);
          ...
          expect(res.body.post.author).to.not.have.property('email');
          expect(res.body.post.author).to.not.have.property('password');
          expect(res.body.post.author).to.not.have.property('notifications');
          expect(res.body.post.author).to.not.have.property('phone');
          expect(res.body.post.author).to.not.have.property('phone2');
          expect(res.body.post.author).to.not.have.property('address');
          expect(res.body.post.author).to.not.have.property('assignedProperties');
          expect(res.body.post.updatedBy).to.not.have.property('email');
          expect(res.body.post.updatedBy).to.not.have.property('password');
          expect(res.body.post.updatedBy).to.not.have.property('notifications');
          expect(res.body.post.updatedBy).to.not.have.property('phone');
          expect(res.body.post.updatedBy).to.not.have.property('phone2');
          expect(res.body.post.updatedBy).to.not.have.property('address');
          expect(res.body.post.updatedBy).to.not.have.property('assignedProperties');
          done();
        });
    });
  });
